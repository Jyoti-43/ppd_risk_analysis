...
export default function CreatePostPage() {
  ...
  const { title, content, topics, isAnonymous, isSensitive } = formData;
  ...
  const handleSaveDraft = async () => {
    setIsSaving(true);
    try {
      // Save current form data to localStorage or backend
    ...
    <div className="relative flex min-h-screen flex-col overflow-x-hidden bg-background">
      ...
      <main className="flex-grow">
        <div className="container max-w-[1200px] mx-auto px-6 py-8">
          <div className="mb-8">
            <h1 className="text-[36px] lg:text-[44px] font-black text-foreground mb-3">
              Share Your Journey
            </h1>
            <p className="text-muted-foreground text-base lg:text-lg leading-relaxed max-w-[700px]">
              Your voice matters. Share your experience in a safe, supportive
              space. You can choose to remain anonymous.
            </p>
          </div>
                  ...
                  <div className="flex flex-col gap-3 pt-4 border-t border-border">
                    <div className="flex items-center gap-3">
                      <Checkbox
                        ...
                        onCheckedChange={(checked) =>
                          dispatch(setIsAnonymous(checked as boolean))
                        }
                      />
                      <label
                        htmlFor="anonymous"
                    ...
                    <div className="flex items-center gap-3">
                      <Checkbox
                        ...
                        checked={isSensitive}
                        onCheckedChange={(checked) =>
                          dispatch(setIsSensitive(checked as boolean))
                        }
                      />
                      <label
                        htmlFor="sensitive"
            ...
            <div className="flex flex-col gap-6">
              ...
              <div className="bg-white rounded-2xl border border-border p-6">
                <div className="flex items-center gap-2.5 mb-4">
                  <span className="material-symbols-outlined text-primary text-[24px] fill">
                    lightbulb
                  </span>
              ...
              <div className="bg-white rounded-2xl border border-border p-6">
                ...
                <p className="text-[14px] text-muted-foreground leading-relaxed mb-4">
                  We are a supportive community. Please be kind, respectful, and
                  mindful that everyone is on their own journey.
                </p>
                <a
                  href="#"
              ...
              <div className="bg-primary/5 border-2 border-primary/20 rounded-2xl p-6">
                <div className="flex items-center gap-2.5 mb-3">
                  <span className="material-symbols-outlined text-destructive text-[24px] fill">
                    error
                  </span>
                  <h3 className="text-[15px] font-bold text-foreground uppercase tracking-wider">
                    Need Immediate Help?
                ...
                <p className="text-[14px] text-muted-foreground leading-relaxed mb-4">
                  If you are feeling overwhelmed or unsafe, please reach out to
