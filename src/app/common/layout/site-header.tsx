...
function SiteNavAuth() {
  return (
    <nav className="hidden lg:flex items-center gap-9">
      <Link href="/" className="text-[15px] font-medium text-foreground hover:text-primary transition-colors">
        Home
      </Link>
      <Link href="/screening" className="text-[15px] font-medium text-foreground hover:text-primary transition-colors">
        Screening
      </Link>
      <Link href="/resources" className="text-[15px] font-medium text-foreground hover:text-primary transition-colors">
        Resources
      </Link>
      <Link href="/community" className="text-[15px] font-bold text-primary">
        Community
      </Link>
      <Link href="/profile" className="text-[15px] font-medium text-foreground hover:text-primary transition-colors">
        Profile
      </Link>
    </nav>
  )
...
function SiteNav() {
  return (
    <nav className="hidden lg:flex items-center gap-9">
      ...
      <Link href="/login" className="text-[15px] font-medium text-foreground hover:text-primary transition-colors">
        Screening
      </Link>
      <Link href="/login"  className="text-[15px] font-medium text-foreground hover:text-primary transition-colors">
        Resources
