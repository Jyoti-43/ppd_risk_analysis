...
export default function Button({ variant = 'primary', children, className, ...props }: ButtonProps) {
  const baseStyles = " py-3 rounded-4xl transition-all duration-200 flex items-center justify-center gap-2";
  
  const variants = {
    // Uses your --color-button and --color-button-hover from @theme
    primary: "bg-button  hover:bg-button-hover  font-secondary font-semibold text-lg",
