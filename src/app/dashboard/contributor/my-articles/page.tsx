...
const articles = [
  ...
  {
    id: 3,
    title: "Understanding the Baby Blu...",
  ...
  {
    id: 4,
    title: "5 Mindfulness Techniques for...",
    category: "Self-Care",
    status: "Draft",
    lastModified: "Oct 28, 2023",
    image: "/article-thumb-4.jpg",
  },
  {
    id: 5,
...
export default function MyArticlesPage() {
  ...
  const filteredArticles = articles.filter((article) => {
    ...
    const matchesStatus =
      ...
      (activeTab === "Pending Review" && article.status === "Pending Review") ||
  ...
  const tabs = [
    ...
    {
      name: "Pending Review",
      count: articles.filter((a) => a.status === "Pending Review").length,
    },
    {
      name: "Drafts",
              ...
              filteredArticles.map((article) => (
                ...
                >
                  ...
                  <TableCell className="py-1 whitespace-nowrap">
                    <Badge
                      className={cn(
                        "px-4 py-1.5 rounded-xl uppercase text-xs font-black border-none tracking-widest",
